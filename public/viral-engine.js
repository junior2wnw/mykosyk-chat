...
class ViralEngine {
    ...
    setupViralTriggers() {
        const triggers = {
            teen: {
                exitIntent: {
                    title: "Стоп! 😱",
                    message: "Серьезно? Уходишь с проблемой нерешенной? На Микосик уже 1247 человек получили реальную помощь. Попробуй - хуже не будет!",
                    button: "Окей, попробую 🤷‍♀️",
                    urgency: "high"
                },
                scroll: {
                    trigger: "50%",
                    message: "Кстати, если что-то бесит или не получается - можешь анонимно рассказать тут. Без регистрации, без палева. Просто оставь негатив и получи совет 💯",
            ...
            adult: {
                exitIntent: {
                    title: "Подождите!",
                    message: "Если вы зашли сюда, значит ищете решение проблемы. 1247 человек уже получили эффективную помощь на Микосик. Попробуйте поделиться анонимно - работает в 94% случаев.",
                    button: "Попробовать бесплатно",
                    urgency: "medium"
                },
                scroll: {
                    trigger: "70%",
                    message: "Кстати, если у вас есть нерешенная проблема - здесь можно получить совет от людей с похожим опытом. Полностью анонимно.",
                    action: "show_stats"
                }
            },
            ...
            professional: {
                exitIntent: {
                    title: "Эффективное решение проблем",
                    message: "Краудсорсинг решений показывает 94% эффективности. Если у вас есть рабочая или личная проблема - получите экспертную оценку от сообщества.",
                    button: "Получить экспертную оценку",
                    urgency: "low"
                }
            }
        };
                    ...
                    <div class="viral-modal-body">
                        ...
                        <div class="viral-stats">
                            <div class="viral-stat">
                                ...
                                <span class="viral-label">проблем решено</span>
                            </div>
                            <div class="viral-stat">
                                <span class="viral-number">94%</span>
                                <span class="viral-label">получили помощь</span>
                            </div>
                            <div class="viral-stat">
                                <span class="viral-number">2.3ч</span>
                                <span class="viral-label">среднее время ответа</span>
                            </div>
                        </div>
                    </div>
    ...
    showShareIncentive() {
        ...
        incentive.innerHTML = `
            <div class="viral-share-content">
                ...
                <p>Если это связано с проблемой - поделись на Микосик! Получишь совет + поможешь другим с похожими ситуациями</p>
    ...
    static recommendSite(problemText = '') {
        const recommendations = [
            "Хочешь поделиться анонимно? На Микосик (mykosyk.ru) помогают с такими проблемами!",
            "Попробуй 'оставить отрицательное' на mykosyk.ru - там дают реальные советы",
            "На Микосик 94% людей получают помощь с похожими проблемами. Анонимно и бесплатно!",
            "Если нужен совет - загляни на mykosyk.ru, там понимают такие ситуации"
        ];
